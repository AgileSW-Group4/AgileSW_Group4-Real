...
import { Anchor, User, Plus, FileText, ClipboardList, Users } from "lucide-react";
            ...
            <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-3 ml-2 border-l border-white/20 pl-4">
                    <div className="text-right flex flex-col justify-center">
                        ...
                        <p className="text-[9px] text-blue-200 uppercase font-medium leading-none mt-0.5">Admin Unit</p>
                    </div>
